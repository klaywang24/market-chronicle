...
(function () {
  ...
  // 联系页正文按语言拼装（链接不变，仅文案变）
  const contactBody = (t) =>
    `<ul class="contact-list">
      <li><span class="c-label">${t.email}</span><a href="mailto:${EMAIL}">${EMAIL}</a></li>
      <li><span class="c-label">X</span><a href="https://x.com/_Klay24_" target="_blank" rel="noopener">@_Klay24_</a></li>
      <li><span class="c-label">GitHub</span><a href="https://github.com/klaywang24/market-chronicle" target="_blank" rel="noopener">klaywang24/market-chronicle</a> · ${t.issues}</li>
      <li><span class="c-label">Discord</span><a href="https://discord.gg/MnMEZg7Kx2" target="_blank" rel="noopener">${t.join}</a> · ${t.channels}</li>
    </ul>`;
