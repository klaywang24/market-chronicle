...
(function () {
  ...
  const ICON = {
    ...
    email: '<svg class="c-ic c-ic-mail" viewBox="0 0 24 24" aria-hidden="true"><path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0l-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z"/></svg>',
...
<p>Honest disclosure (as of July 2026): under these rules the LEAPS strategy (buying the Nasdaq-100) compounds to roughly <strong>9.5×</strong> since 2011 — above roughly <strong>5.8×</strong> for buy-and-hold S&amp;P 500, below roughly <strong>13.0×</strong> for buy-and-hold Nasdaq-100; the K strategy to roughly <strong>2.6×</strong> since 2020 versus <strong>3.4×</strong> for holding the Nasdaq. <strong>This site does not claim these signals beat buy-and-hold of the same instrument.</strong> The ledger's value is telling you where today stands in history, and what actually happened after every sentiment extreme — wins and losses alike.</p>
