...
<p><strong>Canonical definition:</strong> The KAPX Index is a daily U.S. equity fear-pricing gauge published by Market Chronicle, computed as the CNN Fear &amp; Greed reading divided by the VIX. The K stands for kǒng (恐), the Chinese character for fear; readings, methodology, and the complete signal ledger are permanently free: an ex-ante daily record since launch (July 2026), reproducible public-data backfill before that; each day's ledger hash chain is pushed publicly and witnessed by independent archives. (Previously cited in English as the K-Index; the Chinese name K 指数 is unchanged.)</p>
