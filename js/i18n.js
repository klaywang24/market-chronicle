...
(function () {
  ...
  const D = {
    ...
    "升水 · 长端更贵": ["Contango · long end pricier", "", "", ""], "倒挂 · 近端恐慌": ["Inverted · near-term panic", "", "", ""],
    ...
    "1 年 ★": ["1y ★", "", "", ""],
    "期限结构": ["Term structure", "", "", ""],
    "陡 contango · 长端更贵": ["steep contango · long end pricier", "", "", ""],
    ...
    "今天买长期期权（LEAPS，12–18 个月）在历史上算贵还是便宜？头条 = 1 年期市场波动率（VIX1Y）在过去 3 年的百分位，越高越贵。它只描述成本，不预测方向、不构成买卖建议——像油价牌告诉你今天油贵不贵，但不替你决定要不要开车。": ["Is buying long-dated options (LEAPS, 12–18 months) historically expensive or cheap today? The headline is the percentile of 1-year implied volatility (VIX1Y) over the trailing 3 years — higher = pricier. It describes cost only, not direction, and is not advice — like a fuel-price sign telling you whether gas is dear today, without deciding whether you should drive.", "", "", ""],
    ...
    "这是温度计，不是策略。它只回答\"贵还是便宜\"，不回答\"该不该买\"——买不买还需要你自己对方向的判断。每个读数带 Git 时间戳，事前记录、改不了。": ["This is a thermometer, not a strategy. It only answers \"expensive or cheap,\" never \"buy or not\" — that still needs your own read on direction. Every reading carries a Git timestamp, recorded ex-ante and unchangeable.", "", "", ""],
