...
(function () {
  ...
  const D = {
    ...
    "免费邮件列表：每周一封台账读数（不收费，与付费简报不同）": ["Free mailing list: one email a week with ledger readings (free — different from the paid digest)", "", "", ""],
    "免费订阅": ["Subscribe free", "", "", ""],
    "极端读数出现时加发一封。随时退订，不发广告。": ["An extra issue when readings hit extremes. Unsubscribe anytime; no ads.", "", "", ""],
