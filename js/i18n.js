...
(function () {
  ...
  const D = {
    ...
    "盘前信号简报 · 创始价 $9.9": ["Pre-market brief · founding $9.9", "", "", ""],
    ...
    "恐慌中的买点": ["Buying into Panic", "", "", ""],
    "在人群最恐慌的那天买入或加仓，之后 1 到 12 个月，市场通常给了什么？": ["Buy or add on the day the crowd is most afraid — what did the market usually give over the next 1 to 12 months?", "", "", ""],
    "持有期矩阵：五个视界的胜率、平均与中位收益": ["The holding-period matrix: win rate, average and median returns across five horizons", "", "", ""],
    "牛市里无人在意恐惧，潮水退去时买点才显形。每次信号首日买入或加仓，之后 20 / 40 / 60 / 120 / 250 个交易日（约 1 / 2 / 3 / 6 / 12 个月）的胜率、平均与中位涨跌幅（纳指 / 标普双锚）；较新的信号尚未走完长视界，不计入该列。这不是跑赢满仓持有的证据（总收益见第三章与方法论）——它回答的是恐慌中手握现金的人最关心的问题：这些时点之后，市场大多走向了哪里": ["No one cares about fear in a bull market; entry points only show when the tide goes out. Buy or add at each signal's first close; win rate, average and median change 20 / 40 / 60 / 120 / 250 trading days (≈1 / 2 / 3 / 6 / 12 months) later, Nasdaq / S&P dual anchors; recent signals that haven't completed a horizon are excluded from that column. This is not evidence of beating buy-and-hold (see Chapter III and the Methodology) — it answers the question that matters to anyone holding cash in a panic: where did the market usually go from these moments", "", "", ""],
