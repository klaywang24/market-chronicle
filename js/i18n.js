...
(function () {
  ...
  const D = {
    ...
    "K 指数 = CNN 恐惧贪婪指数 ÷ VIX。当恐惧（CNN 走低）与波动（VIX 走高）交叉，K 跌破 1 —— 2020 年以来的每一次，都对应纳指 100 的一次深度回调。下方逐次对账。": [
      "KAPX Index = CNN Fear & Greed ÷ VIX. When fear (CNN falling) crosses volatility (VIX rising), K breaks below 1 — every time since 2020 has coincided with a deep NDX correction. Audited signal by signal below.",
      "Indice KAPX = CNN ÷ VIX. Quand K passe sous 1, chaque occurrence depuis 2020 a coïncidé avec une correction profonde du NDX. Audit ci-dessous.",
      "KAPX Index = CNN ÷ VIX. Fällt K unter 1, fiel dies seit 2020 jedes Mal mit einer tiefen NDX-Korrektur zusammen. Prüfung unten.",
      "Índice KAPX = CNN ÷ VIX. Cada vez que K cae bajo 1 desde 2020 ha coincidido con una corrección profunda del NDX. Auditoría abajo."],
