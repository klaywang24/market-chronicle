...
(function () {
  ...
  const D = {
    ...
    "信号首日买入纳指 100、持有 60 个交易日后离场，持有期内新信号跳过；两条虚线为同期一直持有纳指与标普。空仓期记零、不计成本与滑点，完整口径见方法论": ["Buy the Nasdaq-100 at each signal's first close, exit after 60 trading days, skip signals inside a holding period; the two dashed lines are buy-and-hold Nasdaq and S&P. Cash earns zero, no costs or slippage — full rules in the Methodology", "", "", ""],
    "纳指 100（对数坐标）· 圆点 = LEAPS 窗口开启（2011 年起）· 菱形 = K < 1 信号（2020 年起）· 点标记看当次结果 · 底部滑块可拖拽缩放": ["Nasdaq-100 (log scale) · dots = LEAPS windows since 2011 · diamonds = K < 1 signals since 2020 · tap a marker for its outcome · drag the bottom slider to zoom", "", "", ""],
    "窗口首日买入纳指 100、持有 12 个月后离场，持有期内新窗口跳过；两条虚线为同期一直持有纳指与标普。空仓期记零、不计成本与滑点，完整口径见方法论": ["Buy the Nasdaq-100 at each window's first close, exit after 12 months, skip windows inside a holding period; the two dashed lines are buy-and-hold Nasdaq and S&P. Cash earns zero, no costs or slippage — full rules in the Methodology", "", "", ""],
