...
(function () {
  ...
  const D = {
    ...
    "（两条虚线）。空仓期记零、不计成本与滑点，完整口径见方法论：列在这里是为了连输的也摊开，不是让你照做": [" (the two dashed lines). Cash periods count as zero; costs and slippage excluded; full methodology on the Methodology page — listed so the losses are laid out too, not for you to copy", "", "", ""],
    ...
    "保护费拆成四块": ["The premium, in four pieces", "", "", ""],
    ...
    "三年里怎么走的": ["Where it has been over three years", "", "", ""],
    ...
    "历史参照 · 极端读数之后": ["Historical reference · After an extreme reading", "", "", ""],
    "以下为描述性历史记录，不是买卖建议": ["A descriptive historical record, not advice.", "", "", ""],
    "极端读数之后": ["After an extreme reading", "", "", ""],
    "逐次对账": ["Each extreme, settled", "", "", ""],
    ...
    "当天保费和一年后": ["That day's premium and a year later", "", "", ""],
    ...
    "个股比大盘贵多少": ["Single names versus the index", "", "", ""],
    ...
    "谁的空头最挤": ["Whose short side is most crowded", "", "", ""],
    "用补仓天数（持仓 ÷ 日均成交量）在自身近两年中的位置。它回答的是相对于这只票自己的流动性、空头有多挤，而不是谁被做空的股数多（大票天然多）。持仓高 ≠ 有人看空：做市商对冲、ETF 申赎套利、可转债与并购套利都会留下空头持仓。": ["Days-to-cover (short interest ÷ average daily volume), ranked within each name's own past two years. It answers “how crowded is the short side relative to this name's own liquidity” — not “who has the most shares sold short” (large caps always do). High short interest does NOT mean someone is bearish: market-maker hedging, ETF create/redeem arbitrage, convertible and merger arbitrage all leave short positions behind.", "", "", ""],
    ...
    "持仓和补仓天数": ["Shares held and days to cover", "", "", ""],
    ...
    "被否掉的提案": ["A proposal the data rejected", "", "", ""],
    ...
    "显著性": ["Significance", "", "", ""],
    "校正后一只不剩": ["None survive correction", "", "", ""],
    ...
    "口径实验室": ["Yardstick Lab", "", "", ""],
    "换个算法就翻了": ["Change the method, the answer flips", "", "", ""],
    ...
    "历史上每次极端恐惧（CNN 恐贪 < 25）之后，市场怎么走了？以下是一份诚实的历史记录：陈列之后发生了什么，含赢的和输的，供你参照，不构成买卖建议。": ["Historically, what did the market do after each extreme fear (CNN Fear & Greed < 25)? Below is an honest record — showing what happened next, wins and losses alike, for reference, not advice.", "", "", ""],
    ...
    "这是温度计，不是策略。它只回答贵还是便宜，不回答该不该买。每个读数带 Git 时间戳，事前记录、公开可查。": ["This is a thermometer, not a strategy. It only answers \"expensive or cheap,\" never \"buy or not.\" Every reading carries a Git timestamp — recorded ex-ante, publicly verifiable.", "", "", ""],
    ...
    "恐惧极值标记的是情绪，不是估值底：2021 下半年几次极端恐惧，12 个月后仍在下方。这里陈列的是之后发生了什么，含赢与输，供你参照，不替你决定。": ["Fear extremes mark sentiment, not valuation bottoms — several extremes in late 2021 were still lower 12 months on. What's shown here is what happened next, wins and losses, for reference — it does not decide for you.", "", "", ""],
    ...
    "纳指 100 有多科技？": ["How \"tech\" is the Nasdaq-100?", "À quel point le Nasdaq-100 est-il « tech » ?", "Wie „Tech“ ist der Nasdaq-100?", "¿Qué tan «tecnológico» es el Nasdaq-100?"],
