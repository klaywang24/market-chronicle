...
(function () {
  ...
  const D = {
    ...
    "这把尺子的定义、公式与口径，另有一页备查 →": ["The definition, formula and conventions of this gauge, on one reference page →", "", "", ""],
    "KAPX 术语页": ["KAPX Index · term page", "", "", ""],
    "恐惧的标价术语页": ["Fear-Price Index · term page", "", "", ""],
