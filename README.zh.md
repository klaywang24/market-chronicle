...
**自己验一遍**（这才是重点）：哈希链、每一层**证明什么与不证明什么**、以及可直接粘贴运行的
重算命令，全在 **[`data/README.md`](data/README.md)** —— 包含如何从 Internet Archive
取出旧快照，与现在公开的这份逐行比对。
...
| Tab | 内容 |
|---|---|
| **标普 500** | 十四章：百年走势 · 逐年成绩单与收益分布 · 持有期胜率 · 滚动 5/10/20 年 · 牛熊周期 · 左尾放大镜 · 回撤谱系 · 估值两条曲线（CAPE 1871→ / PE TTM）· **离中位数多远**（三条历史中位数锚 + 当前百分位）· EPS · VIX 保护的价钱 · 十二个月的脾气 · 行业占比 · 503 家成分股 |
...
估值的位置（PE 历史 + 百分位，银行类自动换 PB）→ 估值驱动 vs EPS 驱动 →
